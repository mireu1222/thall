...
(function (window, document, Math) {
    ...
    // INSERT POINT: DEFAULTS
        ...
        if (this.options.autoCenterScroll) {
    ...
    // INSERT POINT: _translate
        ...
        _initEvents: function (remove) {
            ...
            if (this.options.prevButton && this.options.nextButton) {
                var self = this;
                (this.$prevButton = $(this.options.prevButton)).on('click', function (e) {
                    e.preventDefault();
                    self.prevPage();
                    self._activateButtons();
                });

                (self.$nextButton = $(this.options.nextButton)).on('click', function (e) {
                    e.preventDefault();
                    self.nextPage();
                    self._activateButtons();
                });
        ...
        _wheel: function (e) {
            ...
            if (this.options.prevButton && this.options.nextButton) {
                if (this.$prevButton) {
                    this.$prevButton.prop('disabled', newX === 0);
                    if (newX === 0) {
                ...
                if (this.$nextButton) {
                    this.$nextButton.prop('disabled', newX === this.maxScrollX);
